            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#contact-us">Login</a></li>
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
 ...
 <section id="about">
        <div class="container">
            ...
            <div class="section-header">
                ...
                <p class="text-center wow fadeInDown">¿Que es Lavando tu auto .com ?<br>Lavando tu auto .com ofrece a sus clientes un servicio moderno y profesional en poco tiempo y con excelente calidad, donde revolucionamos el giro de la limpieza de autos de manera fácil y práctica por medio de una aplicación con cargo a tu tarjeta de crédito y con servicio a domicilio (casa, trabajo, restaurantes, centros comerciales, entre otros)</p>
            </div>
...
<section id="pricing">
        <div class="container">
			...
			<div class="col-md-4">
						...
						<li class="grey">Revisión de objetos dentro de su auto</li>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item">
                                <p><img class="img-thumbnail" src="images/team/03.jpg" alt=""></p>
...
Más comodidad a tus clientes ofreciendo un servicio a domicilio. </p>
    ...
    <section id="contact-us">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Entrar</h2>
    ...
    <section id="contact">
		...
		placeholder="Correo" id="name" required
		data-validation-required-message="Porfavor Ingrese su Correo" />
		<p class="help-block"></p>
		</div>
		</div>
		<div class="control-group">
		<div class="controls">
		<input type="email" class="form-control pull-center" placeholder="Contraseña" align="center"
		id="email" required
		...
		<br>
		<center>
		<button type="submit" class="btn btn-primary pull-center">Enviar</button><br />
    <h9><u><em><a href="/registrate">Olvidé mi contraseña</a></u></em>
    <br>
    <br>
    <h5><a href="/registrate">Crear una cuenta</a>
		</form>
